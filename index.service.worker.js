...
const CACHE_VERSION = "1675520643|6376255";
const CACHE_PREFIX = "h4ck 2 the /root-sw-cache-";
...
const CACHABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgodotyaml.wasm"];
